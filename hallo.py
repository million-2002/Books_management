...
Flask类只有一个必须指定的参数，即程序主模块或者包的名字，__name__是系统变量，
该变量指的是本py文件的文件名"""
from flask import Flask, render_template#Flask是一个类

app = Flask(__name__)#把类实例化为app
#  第二部分，路由和视图函数：
